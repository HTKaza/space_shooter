...
class Meteor(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(f'image/meteors/{color}_{size}_{num}.png')
    ...
    def update(self):
        ...
        if pygame.sprite.spritecollide(self, player_group, False):
            ...
            if player.invincibility_frames == 0:
                ...
                # display the damege image for 50 frames
...
bg = pygame.image.load('images/galaxydep.png')
...
while running:
    ...
    # create additional meteors every 100th interation off the game loop
    if loop_ctr == 100:
